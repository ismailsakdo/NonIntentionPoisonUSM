...
# =============================================================================
# 1. READ AND AGGREGATE RAW CSV DATA (Real Data Extraction) - if you need to request for the data, contact PRN, USM email: drsai@usm.my
# =============================================================================
...
national_data = pd.DataFrame({
    ...
    'DOSM_Suicide_Deaths': [273, 224, 290, 323, 424, 401, 411, 408, 415, 423, 444, 452, 458, 609, 641, 1131]
})
...
# CORRECTED TO MATCH MANUSCRIPT: SMR +87.5% and NPC Cases -29.2%

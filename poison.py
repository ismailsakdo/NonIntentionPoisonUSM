...
Original file is located at
    https://colab.research.google.com/drive/1bbs2c06HnEhyI9W4lmqv98My0vW-i3Ok
"""
...
# Calculate NPC_AIR on the full DataFrame (df)
df['NPC_AIR'] = (df['NPC_Suicidal_Total'] / df['Population']) * 100000

# --- Define the correlation period (2006-2019) ---
# 🛠️ CORRECTION: df_corr is created AFTER NPC_AIR is calculated on df
...
# These lines now correctly find 'NPC_AIR' in df_corr
corr_pairs = {
...
# This line now correctly accesses 'NPC_AIR' in df_corr
...
# Using Unicode rho for cleaner display outside of LaTeX
df_corr_output_main = df_corr_output.iloc[:3]
df_corr_output_main.columns = ['Correlation Pair', "Spearman's ρ", 'P-value', 'Interpretation']
...
# Using Unicode rho for cleaner display outside of LaTeX
df_corr_output_age.columns = ['Correlation Pair', "Spearman's ρ", 'P-value', 'Interpretation']
